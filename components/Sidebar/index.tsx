    ...
    },
    {
        ...
        menuItems: [
            ...
            },
            {
                ...
                route: "#",
                children: [
                    { label: "Xem hồ sơ cá nhân", route: "/profile" },
                    { label: "Đổi mật khẩu", route: "/profile/change-password" },
                ],
            },
            {
                icon: (
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
    ...
    return (
        <ClickOutside onClick={() => setSidebarOpen(false)}>
            <aside
                className={`fixed left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear lg:translate-x-0 dark:bg-boxdark ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
                    }`}
            >
                {/* <!-- SIDEBAR HEADER --> */}
                <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
                    <Link href="/">
                        <Image width={176} height={32} src={"/images/WLP-logo.jpg"} alt="Logo" priority />
                    </Link>
