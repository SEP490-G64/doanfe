                                ...
                                <div className="p-6.5">
                                    <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                        ...
                                        <div className="w-full xl:w-1/2">
                                            ...
                                            <input
                                                defaultValue={
                                                    selectedFromBranch?.phoneNumber
                                                        ? selectedFromBranch?.phoneNumber
                                                        : ""
                                                }
                                                type="text"
                                    ...
                                    <div className="mb-4.5">
                                        ...
                                        <input
                                            defaultValue={
                                                selectedFromBranch?.location ? selectedFromBranch?.location : ""
                                            }
                                            placeholder="Nhập địa chỉ"
                                            disabled
                                            className="w-full rounded-lg border-1.5 border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                    ...
                                    <div className="mb-4.5">
                                        ...
                                        <textarea
                                            ...
                                            disabled={
                                                viewMode === "details" ||
                                                ["CHO_DUYET", "CHO_HANG", "HOAN_THANH"].includes(
                                                    inboundStatus as string
                                                )
                                            }
                                            className="w-full rounded-lg border-1.5 border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                        ></textarea>
                                                ...
                                                case "HOAN_THANH":
                                                    return (
                                                        <>
                                                            ...
                                                            <p>
                                                                <i style={{ color: "red" }}>
                                                                    Lưu ý: Nếu xác nhận hoàn thành đơn hàng, bạn không
                                                                    thể quay lại chỉnh sửa được nữa.
                                                                </i>
                                                            </p>
                                                        </>
                                                    );
