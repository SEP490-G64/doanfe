...
import { deleteInventoryCheck, getListInventoryCheck } from "@/services/inventoryCheckServices";
...
const InventoryCheckTable = () => {
    ...
    const handleOpenModal = (inboundId: string) => {
                    ...
                    <div className="flex items-center justify-center space-x-3.5">
                        <Tooltip content="Chi tiết">
                            <button
                                ...
                                onClick={() => router.push(`/inventory-check-note/details/${product.id}`)}
                            >
                                <svg
                        ...
                        <Tooltip color="secondary" content="Cập nhật">
                            <button
                                ...
                                onClick={() => router.push(`/inventory-check-note/update/${product.id}`)}
                            >
                                <FaPencil />
                            </button>
                        </Tooltip>
