...
const UnitsTable = () => {
    ...
    const getListUnitByPage = async () => {
        ...
        try {
            ...
            if (response.message === "200 OK") {
                setUnitData(
                    response.data.map((item: Unit, index: number) => ({
                        ...item,
    ...
    const handleDelete = async (unitId: string) => {
        ...
        setLoading(true);
        try {
            const response = await deleteUnit(unitId, sessionToken);
    ...
    const renderCell = useCallback((unit: Unit, columnKey: React.Key) => {
        ...
        switch (columnKey) {
            case "no.":
                return <h5 className="text-black dark:text-white">{unit.index}</h5>;
            case "unitName":
                return <h5 className="font-normal text-black dark:text-white">{unit.unitName}</h5>;
            case "actions":
                return (
                    <div className="flex items-center justify-center space-x-3.5">
                        <Tooltip content="Chi tiết">
                            <button
                                ...
                                onClick={() => router.push(`/units/details/${unit.id}`)}
                            >
                                <svg
                        ...
                        <Tooltip color="secondary" content="Cập nhật">
                            <button
                                ...
                                onClick={() => router.push(`/units/update/${unit.id}`)}
                            >
                                <FaPencil />
                            </button>
                        </Tooltip>
