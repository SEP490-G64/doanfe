...
const TableTwo = () => {
    return (
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="grid grid-cols-6 border-t border-stroke px-4 py-4.5 sm:grid-cols-8 md:px-6 2xl:px-7.5 dark:border-strokedark">
            ...
            {productData.map((product, key) => (
                <div
                    className="grid grid-cols-6 border-t border-stroke px-4 py-4.5 sm:grid-cols-8 md:px-6 2xl:px-7.5 dark:border-strokedark"
                    key={key}
                >
                    <div className="col-span-3 flex items-center">
